...
import { exportBibtex, downloadBibtex, removeFromLibrary, fetchPdf, uploadPdf, getPdfViewUrl } from '../services/api'
  ...
  return (
      <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-sm transition-shadow">
        ...
        <div className="mt-3 pt-3 border-t border-slate-100 flex items-center gap-2 flex-wrap">
          ...
          {hasPdf && (
              <a
                  href={getPdfViewUrl(paper.dblp_key)}
                  target="_blank"
                  rel="noreferrer"
                  className="text-xs font-semibold px-2.5 py-1 rounded-lg border border-emerald-200 text-emerald-600 hover:bg-emerald-50 transition-colors"
              >
                📄 View PDF
              </a>
          )}
